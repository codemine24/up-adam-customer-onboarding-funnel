                ...
                <div className="step-container">
                        ...
                        >
                            ...
                            <div>
                                ...
                                {shouldShowError('howHeard') && (
                                    <p className="text-red-500 text-sm">{errors.howHeard?.message}</p>
                                )}
                            </div>
                        </motion.div>
                    )}
                    ...
                    {step === 3 && (
                        <motion.div
                            ...
                            transition={{ duration: 0.6, ease: 'easeOut' }}
                        >
                            <h2 className="text-2xl mb-4">What are you most interested in?</h2>
                            <Controller
                                name="interests"
                                control={control}
                                render={({ field }) => (
                                    <div className="space-y-2">
                                        <div>
                                            <input
                                                type="checkbox"
                                                checked={field.value?.includes('Product Updates') || false}
                                                onChange={(e) => {
                                                    const newValue = field.value || [];
                                                    if (e.target.checked) {
                                                        field.onChange([...newValue, 'Product Updates']);
                                                    } else {
                                                        field.onChange(newValue.filter((item: string) => item !== 'Product Updates'));
                                                    }
                                                }}
                                                className="mr-2"
                                            />
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (e.target.checked) {
                                                        ...
                                                        field.onChange(newValue.filter((item: string) => item !== 'Tutorials'));
                                                    }
                                                }}
                                                className="mr-2"
                                            />
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    if (e.target.checked) {
                                                        ...
                                                        field.onChange(newValue.filter((item: string) => item !== 'Webinars'));
                                                    }
                                                }}
                                                className="mr-2"
                                            />
                    ...
                    {step === 4 && (
                        <motion.div
                            ...
                            transition={{ duration: 0.6, ease: 'easeOut' }}
                        >
                            <h2 className="text-2xl mb-4">What's your goal with our product?</h2>
                            <div>
                                <input
                                    type="text"
                                    id="goal"
                    ...
                    <div className={`mt-6 flex ${step === 1 ? 'justify-end' : 'justify-between'}`}>
                        {step > 1 && (
                            <button type="button" onClick={prevStep} className="text-sm text-neutral-500 hover:underline cursor-pointer">
                                Back
                            </button>
                        )}
                        {step < 5 ? (
