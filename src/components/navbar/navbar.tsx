...
const Navbar = () => {
    ...
    return (
        <nav
            className="flex items-center justify-between w-full relative dark:bg-neutral-950 px-[10px] py-[8px] sticky top-0 z-50">

            {/* logo */}
            <h1 className="text-[1.5rem] font-semibold">Logo</h1>
            ...
            <ul className="items-center gap-[20px] text-[1rem] text-[#424242] md:flex hidden">
                ...
                <li className="before:w-0 hover:before:w-full before:bg-[#3B9DF8] before:h-[2px] before:transition-all before:duration-300 before:absolute relative before:rounded-full before:bottom-[-2px] dark:text-[#abc2d3] hover:text-[#3B9DF8] transition-all duration-300 before:left-0 cursor-pointer capitalize">onboarding</li>
            </ul>
